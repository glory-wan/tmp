...
def main():
    ...
    parser.add_argument("--images", default=r'E:\Experiment\round_1\synthetic\source_image')
    parser.add_argument("--labels", default=r"E:\Dataset\Detection\COCOmini\COCOmini\labels\minitrain2017")
    parser.add_argument("--output-dir", default=r'E:\Experiment\round_1\synthetic\vis_real'),
    parser.add_argument(
        "--max-images",
        type=int,
        default=7500,
